        ...
        public static DocumentTemplate GroupByNamespaceTemplate
        {
            get
            {
                if (groupByNamespaceTemplate == null)
                {
                    ...
                    t.AddBriefDescription();
                    t.AddSection("Fields").AddFieldList().AddBriefDescription();
                    t.AddSection("Properties").AddPropertyList().AddBriefDescription();
                    t.AddSection("Methods").AddMethodList().AddBriefDescription();
                    t.AddDescription();
                }
        ...
        { 
            get
            {
                if (groupByKindTemplate == null)
                {
                    ...
                    t.AddBriefDescription();
                    t.AddSection("Enum values").AddEnumValueList().AddBriefDescription();
                    t.AddSection("Fields").AddFieldList().AddBriefDescription();
                    t.AddSection("Properties").AddPropertyList().AddBriefDescription();
                    t.AddSection("Methods").AddMethodList().AddBriefDescription();
                    t.AddDescription();
